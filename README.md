...
This repository houses the code associated with the paper [**"SINDy-RL for Interpretable and Efficient Model-Based Reinforcement Learning"**](https://www.nature.com/articles/s41467-025-65738-4). A video abstract of the work [can be found here](https://youtu.be/7Q8oNNsZGcA).
